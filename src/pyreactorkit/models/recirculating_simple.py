...
class SimpleRecirculatingReactorIteration(MyReactor):
    """
    ...
    def simulate(self):
        ...
        self.reactor_recirculation.set(T_end, X0=X_edge_end)
...
class SimpleRecirculatingReactor(ConvergingModel):
    recirculating_reactor: SimpleRecirculatingReactorIteration
    X0_last_iteration: dict = None

    def __init__(self, reactor_edge, reactor_recirculation):
        self.recirculating_reactor = SimpleRecirculatingReactorIteration(
    ...
    def apply_parameters(self, parameters: dict):
        ...
        mixing_profile_new *= mdot_tot / np.sum(mixing_profile_new)
    ...
    def format_parameters(self, parameters: np.ndarray):
        ...
        return f"temperature: {T_new:.0f}K, composition: {composition_filtered}, flowrate: {mdot_tot*1e3:.2f} gps"
